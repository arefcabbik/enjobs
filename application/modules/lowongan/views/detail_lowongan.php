            ...
            <div class="row">
              <div class="col-lg-2 col-sm-2 text-right">
                <div class="author">
                  ...
                  <?php if($this->session->userdata('id_user') == $row->id_user){
                      ...
                      echo anchor('Profil/lihat/'.$row->id_user, $row->nama_user, 'attributes');
                      } ?>
                  <!--
              ...
              <div class="col-lg-10 col-sm-10">
                ...
                <blockquote>
                  ...
                  <p>
                    <?php echo $row->spesifikasi_pekerjaan ?>
                  </p>
                  <small>
                    <?php echo $row->nama_user ?>
                  </small>
                ...
                <div class="post-comment">
                  ...
                  <?php echo form_open('Komentar/simpan_komentar', array('class' => 'form-horizontal')); ?> 
